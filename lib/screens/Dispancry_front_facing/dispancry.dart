  ...
  child: Stack(
      children: [
        Container(
          ...
          color: Colors.red,
          child: Image.asset('assets/disp.png',fit: BoxFit.cover,),
        ),
        Align(
          ...
          child: Container(
            ...
            child: Column(
                    ...
                    children: [
                      SizedBox(height: vert_block*1.5,),
                       Row(
                         ...
                         children: [
                           Text('Serra Downtown',style: TextStyle(
                      ...
                      SizedBox(height: vert_block,),
                       Text('Portland   ·  9AM to 9PM',style: TextStyle(
              ...
              fontSize: vert_block*1.7,
                      ...
                      tabs: [
                      Text('Flower',textAlign:TextAlign.center,style: TextStyle(
              
            ),),
            Text('Edibles',textAlign:TextAlign.center,style: TextStyle(
              
            ),),Text('Alcohol',textAlign:TextAlign.center,style: TextStyle(
              
            ),),
            Text('Misc',textAlign:TextAlign.center,style: TextStyle(
                      ...
                      Container(
                        child: Column(
                          children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                         ...
                                         Text('Lux Cinnamon Almond Spread \n\$25',style: TextStyle(
                            ...
                            Padding(
                                padding:  EdgeInsets.symmetric(horizontal: horz_block*4),
                                child: Text('Put it on your toast, bagel, iPhone, anything, really. Actually enjoy your fucking morning for once. Wake up not stressed! Wow. ',style: TextStyle(
                                        fontSize: vert_block*1.6,
                                        fontFamily: 'Gill regular',
                                        color: Mycolors.graytext,
                                        // fontWeight: FontWeight.w700
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          SizedBox(width: horz_block*2,),
                                         Text('Herban Tribe Sour Lemonade \n\$25',style: TextStyle(
                                        fontSize: vert_block*2,
                                        fontFamily: 'Gill regular',
                                        color: Mycolors.blacktext1,
                                       // fontWeight: FontWeight.w700
