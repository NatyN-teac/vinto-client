...
class _TimelinescreenState extends State<Timelinescreen> {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Icon(Icons.check,color: Mycolors.green,size: 30,),
                            ),
                          ),
                          SizedBox(height: vert_block*2,),
                           Container(
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Icon(Icons.location_on_rounded,color: Mycolors.purple,size: 30,),
                            ),
                          ),
                          SizedBox(height: vert_block*2,),
                           Container(
                            ...
                            child: Center(
                              child: Icon(Icons.flag,color: Mycolors.graytext,size: 30,),
                            ),
                          ),
                        ],
                      ),
 ...
 Column(
   ...
   children: [
     ...
     Text('Near to Me Order accepted \nyour order 👍',style: TextStyle(
             ...
             SizedBox(height: vert_block*4,),
     Text('Your driver is on the way!',style: TextStyle(
                                          fontSize: vert_block*2,
                                         // fontFamily: 'Gill medium',
                                          color: Mycolors.blacktext,
                                          fontWeight: FontWeight.w700
                ...
                Row(
                  children: [
                   ...
                   Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                       Text('${widget.driver.firstName} ${widget.driver.lastName}',style: TextStyle(
                        ...
                        Row(
                          children: [
                            Text('Pickup',style: TextStyle(
                             ...
                             Text('    Near To Me Alcolic Drinks',style: TextStyle(
                                              fontSize: vert_block*2,
                                             // fontFamily: 'Gill medium',
                                              color: Mycolors.purple,
                                              fontWeight: FontWeight.w700
                      ...
                      SizedBox(height: vert_block*1.5,),
                        Text('${widget.driver.location.coordinates}',style: TextStyle(
                                              fontSize: vert_block*1.5,
                                             // fontFamily: 'Gill medium',
                                              color: Mycolors.graytext,
                                              fontWeight: FontWeight.w700
                      ...
                      SizedBox(height: vert_block*4.5,),
                             ...
                             SizedBox(height: vert_block*1.5,),
                        Text('Destination ${widget.driver.place ?? "Unknown"}',style: TextStyle(
                                              fontSize: vert_block*1.5,
                                             // fontFamily: 'Gill medium',
                                              color: Mycolors.graytext,
                                              fontWeight: FontWeight.w700
