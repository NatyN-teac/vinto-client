...
class _FooditemState extends State<Fooditem> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        Get.to(Cartscreen(product: widget.product,));
      },
      child: Container(
        child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                            child: Image.network('${ApiEndPoints.IMAGE_URL}/${widget.product.image}',fit: BoxFit.cover,)),
                        ),
                       ...
                       Text('Starts from \$ ${widget.product.price}',style: TextStyle(
