        ...
        child: Column(
          children: [
            ...
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage('assets/disp2.png'),fit: BoxFit.cover)
            ),
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('yourname@email.com',style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: vert_block*2,),
                     Text('Erin Kirk',style: TextStyle(
                  ...
                  SizedBox(
                   ...
                   Row(
                    //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                       Text('1/8 oz Herban Sour Lemonade CBD Flower',style: TextStyle(
                    ...
                    Text('1',style: TextStyle(
                      ...
                      Icon(Icons.edit,size: 15,color: Mycolors.graytext,)
                    ],
                  ),
                   SizedBox(
                    height: vert_block*2,
