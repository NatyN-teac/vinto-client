      ...
      body: Container(
        ...
        child: Column(
          children: [
           ...
           // SizedBox(height: vert_block*6,),
             Text('Earthy and Fruity',style: TextStyle(
               ...
               Padding(
                 ...
                 child: Text('Donec facilisis tortor ut augue lacinia, at viverra est semper. Sed sapien metus, scelerisque nec pharetra id, tempor a tortor. Pellentesque non dignissim neque. ',
            ...
            SizedBox(height: vert_block*2,),
              SmoothPageIndicator(
                      ...
                      Container(
                        ...
                        child: Center(
                          child:  Text('Show me the goods',style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        Text('Feeling different?',style: TextStyle(
                                      fontSize: vert_block*1.5,
                                      //fontFamily: 'Gill medium',
                                      color: Mycolors.blacktext,
                                      //fontWeight: FontWeight.w700
                                    ),),
                        Text('  Start over',style: TextStyle(
                                      fontSize: vert_block*1.5,
                                      //fontFamily: 'Gill medium',
                                      color: Mycolors.green,
                                      //fontWeight: FontWeight.w700
