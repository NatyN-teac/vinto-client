...
class _CartscreenState extends State<Cartscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:  widget.product== null ? Center(child: Column(
        children: [
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage('${ApiEndPoints.IMAGE_URL}/${widget.product.image}'),
                        fit: BoxFit.cover,
                        colorFilter: ColorFilter.mode(Colors.black45.withOpacity(0.25), BlendMode.darken)
                    )
                ),
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: horz_block*6,vertical: horz_block*10),
                  child: Column(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell
                            (
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>Editcart()));
                              },
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Visa Debit ********6051',style: TextStyle(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Product/s',style: TextStyle(
                            fontSize: vert_block*2,
                            color: Colors.black,
                            fontWeight: FontWeight.w700
                        ),),
              ...
              Align(
                ...
                child: InkWell(
                  onTap: (){
                    checkoutController.orderProduct(context, widget.product.sId,quantityController.value.text.trim());
